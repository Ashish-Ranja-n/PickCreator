              ...
              <div className="container-custom relative z-10">
                <div className="text-center max-w-6xl mx-auto pt-8 sm:pt-14 md:pt-16">
                  <motion.div
                    ...
                    className="inline-flex items-center space-x-2 bg-gradient-to-r from-violet-500/10 via-fuchsia-500/10 to-violet-500/10 backdrop-blur-sm border border-violet-200/50 dark:border-violet-800/50 text-violet-700 dark:text-violet-300 px-6 py-3 rounded-full text-sm mt-2 mb-8 sm:mb-10 font-semibold tracking-wide shadow-lg shadow-violet-500/10"
                  >
